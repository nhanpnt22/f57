...
export const h57BitsByLength: Map<number, number> = new Map([
  [H57Length.LEN_8, 8],
  [H57Length.LEN_16, 16],
  [H57Length.LEN_23, 23],
  [H57Length.LEN_29, 29],
...
function toBytes(input: ByteInput) {
...
export function computeHashBLAKE3XOF(input: ByteInput, outputLen: number) {
  if (outputLen <= 0) {
...
export function h57Hash(input: ByteInput, length: number = H57Length.HASH_AUTO) {
  let hashBytes;
...
export function h57Verify(input: ByteInput, h57String: string, length: number = H57Length.HASH_AUTO) {
  try {
...
export function h57IsValid(h57String: string) {
  return isValid(h57String);
}

export function h57IsCanonical(h57String: string) {
