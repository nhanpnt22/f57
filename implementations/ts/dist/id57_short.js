import { ID57Length, id57Generate, id57GenerateDefault, id57IsCanonical, id57IsValid, id57Verify, id57VerifyDefault } from './id57.js';
...
export function id57ShortGenerate(input, length = ID57ShortLength.DEFAULT) {
...
export function id57ShortVerify(input, id57String, length = ID57ShortLength.DEFAULT) {
    try {
...
//# sourceMappingURL=id57_short.js.map