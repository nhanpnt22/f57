...
func ID57ShortGenerate(input []byte, length ID57ShortLength) (string, error) {
...
func ID57ShortGenerateDefault(input []byte) (string, error) {
	return ID57ShortGenerate(input, ID57ShortDefault)
}

// ID57ShortVerify verifies that id57String matches
// ID57ShortGenerate(input, hashFn, length).
func ID57ShortVerify(input []byte, id57String string, length ID57ShortLength) bool {
	expected, err := ID57ShortGenerate(input, length)
	if err != nil {
		return false
	}
...
func ID57ShortVerifyDefault(input []byte, id57String string) bool {
	return ID57ShortVerify(input, id57String, ID57ShortDefault)
}
